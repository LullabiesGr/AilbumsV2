...
const TechOrbitDisplay = memo(function TechOrbitDisplay({
  ...
  return (
    <section className='relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg'>
      <span className='pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-blue-600 to-purple-600 bg-clip-text text-center text-6xl font-bold leading-none text-transparent dark:from-blue-400 dark:to-purple-400'>
        {text}
      </span>
