...
interface AlbumCardProps {
  ...
  onLoadToMainInterface: (album: SavedAlbum) => void;
}

const AlbumCard: React.FC<AlbumCardProps> = ({ album, userId, onViewDetail, onLoadToMainInterface }) => {
    ...
    >
      ...
      <div className="p-4">
        ...
        <button
          onClick={(e) => {
            e.stopPropagation();
            onLoadToMainInterface(album);
          }}
          className="w-full mt-2 px-3 py-2 bg-gradient-to-r from-purple-600 to-pink-600 
