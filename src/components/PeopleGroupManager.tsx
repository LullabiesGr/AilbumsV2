...
const PeopleGroupManager: React.FC = () => {
  ...
  const handleFilterByGroup = (groupId: string) => {
    setSelectedPersonGroup(selectedPersonGroup === groupId ? null : groupId);
  };
          ...
          <div className="p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
            <div className="flex justify-between items-center">
              <div className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <p>Average quality: {selectedGroup.faces.filter(f => f.face_quality).length > 0 
